...
%                     GW2 = sum(max([a_sinGW_true(1:times, 1:2:3), a_mulGW_true(2:7:7*(times-1)+2, 1)], [], 2)) / times / payload_num;
%                     GW3 = sum(max([a_sinGW_true(1:times, 1:2:5), a_mulGW_true(3:7:7*(times-1)+3, 1)], [], 2)) / times / payload_num;
%                     GW4 = sum(max([a_sinGW_true(1:times, 1:2:7), a_mulGW_true(4:7:7*(times-1)+4, 1)], [], 2)) / times / payload_num;
%                     GW5 = sum(max([a_sinGW_true(1:times, 1:2:9), a_mulGW_true(5:7:7*(times-1)+5, 1)], [], 2)) / times / payload_num;
%                     GW6 = sum(max([a_sinGW_true(1:times, 1:2:11), a_mulGW_true(6:7:7*(times-1)+6, 1)], [], 2)) / times / payload_num;
%                     GW7 = sum(max([a_sinGW_true(1:times, 1:2:13), a_mulGW_true(7:7:7*(times-1)+7, 1)], [], 2)) / times / payload_num;
...
%                     GW7 = mean(max([a_sinGW_true(1:times, 2:2:14), a_mulGW_true(2:7:7*(times-1)+2, 2:2:2*21), a_mulGW_true(3:7:7*(times-1)+3, 2:2:2*35), a_mulGW_true(4:7:7*(times-1)+4, 2:2:2*35), a_mulGW_true(5:7:7*(times-1)+5, 2:2:2*21), a_mulGW_true(6:7:7*(times-1)+6, 2:2:2*7), a_mulGW_true(7:7:7*(times-1)+7, 2)], [], 2)) / payload_num;
                    ...
                    GW2 = mean(max([a_sinGW_true(1:times, 2:2:4), a_mulGW_true(2:7:7*(times-1)+2, 2)], [], 2));
                    GW3 = mean(max([a_sinGW_true(1:times, 2:2:6), a_mulGW_true(2:7:7*(times-1)+2, 2:2:2*3), a_mulGW_true(3:7:7*(times-1)+3, 2)], [], 2));
                    GW4 = mean(max([a_sinGW_true(1:times, 2:2:8), a_mulGW_true(2:7:7*(times-1)+2, 2:2:2*6), a_mulGW_true(3:7:7*(times-1)+3, 2:2:2*4), a_mulGW_true(4:7:7*(times-1)+4, 2)], [], 2));
                    GW5 = mean(max([a_sinGW_true(1:times, 2:2:10), a_mulGW_true(2:7:7*(times-1)+2, 2:2:2*10), a_mulGW_true(3:7:7*(times-1)+3, 2:2:2*10), a_mulGW_true(4:7:7*(times-1)+4, 2:2:2*5), a_mulGW_true(5:7:7*(times-1)+5, 2)], [], 2));
                    GW6 = mean(max([a_sinGW_true(1:times, 2:2:12), a_mulGW_true(2:7:7*(times-1)+2, 2:2:2*15), a_mulGW_true(3:7:7*(times-1)+3, 2:2:2*20), a_mulGW_true(4:7:7*(times-1)+4, 2:2:2*15), a_mulGW_true(5:7:7*(times-1)+5, 2:2:2*6), a_mulGW_true(6:7:7*(times-1)+6, 2)], [], 2));
                    GW7 = mean(max([a_sinGW_true(1:times, 2:2:14), a_mulGW_true(2:7:7*(times-1)+2, 2:2:2*21), a_mulGW_true(3:7:7*(times-1)+3, 2:2:2*35), a_mulGW_true(4:7:7*(times-1)+4, 2:2:2*35), a_mulGW_true(5:7:7*(times-1)+5, 2:2:2*21), a_mulGW_true(6:7:7*(times-1)+6, 2:2:2*7), a_mulGW_true(7:7:7*(times-1)+7, 2)], [], 2));
